...
function LogoCloud() {
    const logo= [
        {logo: 'https://static.wixstatic.com/media/32456b_5beaa430406943cdb20b66a6dd1b8be8~mv2.jpg/v1/fill/w_123,h_61,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/ETI.jpg'},
        {logo: 'https://static.wixstatic.com/media/4c5401_fd8349e292914d3c87ac369808b35f1c~mv2.png/v1/crop/x_84,y_91,w_549,h_222/fill/w_135,h_55,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/USAID_Header_Post.png'},
        ...
        {logo: 'https://www.yea.gov.gh/templates/yea/images/presets/preset1/logo.png'},
    ...
    <div className='bg-white py-24 sm:py-32'>
      <div className='mx-auto max-w-7xl px-6 lg:px-8'>
        ...
        <div className='mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5'>
            {logo.map((item, index) => (
            <img key={index} className='col-span-2 max-h-12 w-full object-contain lg:col-span-1' width={158} height={48} src={item.logo} alt="various logo" />
            ))}
        </div>
      </div>
    </div>
