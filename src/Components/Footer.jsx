...
function Footer() {
  ...
  <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
    <div class="xl:grid xl:grid-cols-3 xl:gap-8">
      <div class="space-y-8">
        <img class="h-40 w-auto" src="/sixteen47.jpg" alt="Company name" />
      ...
      <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
        <div className="md:grid md:grid-cols-2 md:gap-8">
          <div>
            ...
            <ul role="list" classNameName="mt-6 space-y-4">
              <li>
                <a href="#" classNameName="text-sm leading-6 text-gray-600 hover:text-gray-900">Marketing</a>
              </li>

              <li>
                <a href="#" classNameName="text-sm leading-6 text-gray-600 hover:text-gray-900">Analytics</a>
              </li>

              <li>
                <a href="#" classNameName="text-sm leading-6 text-gray-600 hover:text-gray-900">Commerce</a>
              </li>
